...
public class AsyncUtils {
    ...
    public static class GetBalanceResponseBaseContext extends SingleResponseBaseContext {
        ...
        public void callSplBase(String amount, Integer decimals, String uiAmountString, Integer error, String errorMessage) {
    ...
    public static class GetSolanaBalanceResponseContext
            extends GetBalanceResponseBaseContext implements JsonRpcService.GetSolanaBalance_Response {
    ...
    public static class GetSplTokenAccountBalanceResponseContext
            extends GetBalanceResponseBaseContext implements JsonRpcService.GetSplTokenAccountBalance_Response {
        public GetSplTokenAccountBalanceResponseContext(Runnable responseCompleteCallback) {
            super(responseCompleteCallback);
        }

        @Override
        public void call(String amount, Byte decimals, String uiAmountString, Integer error, String errorMessage) {
            warnWhenError(TAG, "getSplTokenAccountBalance", error, errorMessage);
            super.callSplBase(amount, Integer.valueOf(decimals), uiAmountString, error, errorMessage);
        }
    }

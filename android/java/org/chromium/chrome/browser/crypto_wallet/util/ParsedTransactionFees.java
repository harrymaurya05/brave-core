...
public class ParsedTransactionFees {
    ...
    public static ParsedTransactionFees parseTransactionFees(TransactionInfo txInfo, NetworkInfo selectedNetwork,
        ...
        final double[] gasFeeArr = calcGasFee(selectedNetwork, networkSpotPrice, 
            isEIP1559Transaction, gasLimit, gasPrice, maxFeePerGas,
            isSolTransaction, solFeeEstimatesFee);
    ...
    public static double[] calcGasFee(NetworkInfo selectedNetwork,
            double networkSpotPrice, boolean isEIP1559Transaction,
            String gasLimit, String  gasPrice, String  maxFeePerGas,

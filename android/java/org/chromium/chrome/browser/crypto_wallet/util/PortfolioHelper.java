...
public class PortfolioHelper {
    ...
    public void calculateBalances(Runnable runWhenDone) {
        ...
        Utils.getTxExtraInfo(mActivity.get(), mSelectedNetwork, mAccountInfos, null, true,
            ...
            for (AccountInfo accountInfo : mAccountInfos) {
                ...
                HashMap<String, Double> thisAccountTokensBalances = Utils.getOrDefault(
                    blockchainTokensBalances, accountAddressLower, new HashMap<String, Double>());
                for (BlockchainToken userAsset : mUserAssets) {
                    ...
                    final double thisCryptoBalance = Utils.isNativeToken(mSelectedNetwork, userAsset)
    ...
    public void calculateFiatHistory(Runnable runWhenDone) {
        ...
        for (BlockchainToken userAsset : mUserAssets) {
            ...
            if (mActivity != null)
                mActivity.get().getAssetRatioService().getPriceHistory(userAsset.symbol.toLowerCase(Locale.getDefault()),

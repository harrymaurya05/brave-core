...
TEST_F(KeyringServiceUnitTest, SelectAddedAccount) {
  ...
  AddAccount(&service, "fil acc 1", mojom::CoinType::FIL);
  AddAccount(&service, "fil acc 2", mojom::CoinType::FIL);
  AddAccount(&service, "fil acc 3", mojom::CoinType::FIL);
  ...
  service.GetKeyringInfo(
      mojom::kFilecoinKeyringId,
      base::BindLambdaForTesting([&](mojom::KeyringInfoPtr keyring_info) {
        ASSERT_EQ(GetSelectedAccount(&service, mojom::CoinType::FIL),
